import { Address, Listener, SignedTransaction, Transaction, TransactionAnnounceResponse, TransactionHttp } from "nem2-sdk";
...
export class TransactionClient {
    ...
    public getAddedFailedTransactionStatus(address: Address, transactionHash: string, listener: Listener) {
